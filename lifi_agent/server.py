...
PRESETS = {
    "safe-transfer": {
        "intent": {"from_chain": "base", "to_chain": "arbitrum", "token": "WETH", "amount": "0.001"},
        "policy": {"max_fee_pct": 0.5, "require_healthy_route": False},
        "description": "Standard Base → Arbitrum WETH→USDC transfer with a 0.5% fee cap.",
        "category": "success",
    ...
    "fee-check": {
        ...
        "description": "Base → Arbitrum transfer with strict 0.3% fee limit to test fee policy enforcement.",
        "category": "success",
        "expected_verdict": "EXECUTABLE",
    },
    "health-check": {
    ...
    "cheapest-route": {
        ...
        "description": "Prefers the cheapest route with a 1% fee ceiling.",
        "category": "success",
        "expected_verdict": "EXECUTABLE",
    },
    "no-quote": {
    ...
    "multi-constraint": {
        "intent": {"from_chain": "base", "to_chain": "arbitrum", "token": "WETH", "amount": "0.001"},
        "policy": {"max_fee_pct": 0.5, "avoid_chains": ["ethereum", "polygon"], "min_output_amount": 9999},
